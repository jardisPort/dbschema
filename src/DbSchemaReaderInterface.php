...
interface DbSchemaReaderInterface
{
     ...
     *
     * @param string $fieldType The database field type (e.g., 'varchar', 'int', 'datetime')
     * @return string|null The corresponding PHP data type (e.g., 'string', 'int', 'DateTime'), or null if unmapped
     */
